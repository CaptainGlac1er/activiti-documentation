...
const DirectoryTree = ({ children, rootName, defaultExpanded = false, expandAll, dotWalk, showFirst }: DirectoryTreeProps) => {
    ...
    <div className={styles.directoryTree}>
      <ExpandAllContext.Provider value={expandAll ?? defaultExpanded ?? false}>
        <DotWalkContext.Provider value={dotWalk ?? true}>
          <ShowFirstContext.Provider value={showFirst ?? null}>
            {rootName ? (
              <>
