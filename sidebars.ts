...
const sidebars: SidebarsConfig = {
  ...
  cloudSidebar: [
    ...
    },
    {
      ...
      collapsed: true,
      label: 'Changelog',
      link: {type: 'doc', id: 'cloud/changelog/index'},
      items: [
        'cloud/changelog/next',
        'cloud/changelog/v9-0-0',
        'cloud/changelog/v8-8-0',
        'cloud/changelog/v8-7-1',
        'cloud/changelog/v8-7-0',
        'cloud/changelog/v8-6-0',
        'cloud/changelog/v8-5-0',
        'cloud/changelog/v8-4-0',
        'cloud/changelog/v8-3-2',
        'cloud/changelog/v8-3-1',
        'cloud/changelog/v8-3-0',
        'cloud/changelog/v8-2-0',
        'cloud/changelog/v8-1-0',
      ],
    },
  ],
  // ---------------------------------------------------------------------------
  ...
  activitiSidebar: [
    ...
    },
    {
      ...
      link: {type: 'doc', id: 'activiti/features/index'},
      items: [
        'activiti/bpmn/common-features',
    ...
    },
    {
      ...
      link: {type: 'generated-index', title: 'Operations and Administration Overview'},
      items: [
        {
          type: 'category',
    ...
    },
    {
      ...
      collapsible: true,
      collapsed: true,
      label: 'Extensibility & Testing',
      link: {type: 'generated-index', title: 'Extensibility and Testing Overview'},
      items: [
      ...
      items: [
        {
          ...
          items: [
            ...
            'activiti/examples/order-management-workflow/bpmn-files',
