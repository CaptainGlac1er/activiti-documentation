...
2. **[01-engine-architecture.md](01-engine-architecture.md)** - Deep dive into architecture
   - System overview
   - Core components
...
3. **[02-engine-configuration.md](02-engine-configuration.md)** - Configuration guide
...
4. **[04-repository-service.md](04-repository-service.md)** - Process definition management
   - Deployments
   - Process definitions
   - Resource management
...
5. **[05-runtime-service.md](05-runtime-service.md)** - Process instance execution
   - Starting processes
   - Process variables
...
6. **[06-task-service.md](06-task-service.md)** - User task management
   - Task creation
   - Task queries
...
7. **[07-history-service.md](07-history-service.md)** - Process auditing
   - History levels
...
2. Read [02-engine-configuration.md](02-engine-configuration.md)
3. Explore service documentation based on needs

### For Architects
1. Study [01-engine-architecture.md](01-engine-architecture.md)
2. Review [02-engine-configuration.md](02-engine-configuration.md)
3. Examine integration patterns in [README.md](README.md)

### For Integration Developers
1. Read [04-repository-service.md](04-repository-service.md)
2. Study [05-runtime-service.md](05-runtime-service.md)
3. Review [06-task-service.md](06-task-service.md)

### For Compliance/Audit
1. Focus on [07-history-service.md](07-history-service.md)
2. Review security documentation in [02-engine-configuration.md](02-engine-configuration.md)
...
- [Activiti Core Common](../../activiti-core-common/README.md)
- [Spring Boot Starter](../activiti-spring-boot-starter/README.md)
