...
public class StockCheckService implements JavaDelegator {
    ...
    public void execute() {
        ...
        outputVariables.put("available", inStock);
        outputVariables.put("levels", Map.of("item1", 100, "item2", 50));
        outputVariables.put("status", inStock ? "IN_STOCK" : "OUT_OF_STOCK");
        outputVariables.put("minThreshold", minThreshold);
        outputVariables.put("inventorySystem", serviceProperties.getInventory().getSystemUrl());
