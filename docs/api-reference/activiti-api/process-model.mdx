...
<DirectoryTree rootName="activiti-api-process-model" expandAll dotWalk>
              ...
              <DirectoryTree.Dir name="process">
                <DirectoryTree.Dir name="model">
                  <DirectoryTree.Dir name="events">
                    ...
                    <DirectoryTree.File icon="…" name="Specific Event Implementations" />
                  </DirectoryTree.Dir>
                  ...
                  <DirectoryTree.File icon="…" name="Other Models" />
                </DirectoryTree.Dir>
