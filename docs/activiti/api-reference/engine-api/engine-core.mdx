...
slug: /api-reference/engine-api/engine-core
...
<DirectoryTree rootName="activiti-engine" expandAll dotWalk showFirst={5}>
  <DirectoryTree.Dir name="org">
    <DirectoryTree.Dir name="activiti">
      <DirectoryTree.Dir name="engine">
        <DirectoryTree.File name="RepositoryService.java" />
        <DirectoryTree.File name="RuntimeService.java" />
        <DirectoryTree.File name="TaskService.java" />
        <DirectoryTree.File name="HistoryService.java" />
        <DirectoryTree.File name="ManagementService.java" />
        <DirectoryTree.File name="DynamicBpmnService.java" />
        <DirectoryTree.File name="ProcessEngineConfiguration.java" />
        <DirectoryTree.Dir name="impl">
          <DirectoryTree.Dir name="bpmn">
            <DirectoryTree.Dir name="behavior" />
            <DirectoryTree.Dir name="parser" />
            <DirectoryTree.Dir name="listener" />
          </DirectoryTree.Dir>
          <DirectoryTree.Dir name="agenda" />
          <DirectoryTree.Dir name="asyncexecutor" />
          <DirectoryTree.Dir name="persistence" />
          <DirectoryTree.Dir name="context" />
        </DirectoryTree.Dir>
        <DirectoryTree.Dir name="event" />
        <DirectoryTree.Dir name="history" />
        <DirectoryTree.Dir name="repository" />
        <DirectoryTree.Dir name="runtime" />
        <DirectoryTree.Dir name="task" />
        <DirectoryTree.Dir name="management" />
      </DirectoryTree.Dir>
    </DirectoryTree.Dir>
  </DirectoryTree.Dir>
</DirectoryTree>
...
flowchart TD
    ...
    subgraph Core["Engine Core"]
        PEC["ProcessEngineConfiguration<br/>- Configuration management<br/>- Service initialization<br/>- Lifecycle management"]
        PE["ProcessEngine<br/>- Central coordinator<br/>- Service provider"]
        CM["Command Manager"]
        BPE["BPMN Executor"]
        JE["Job Executor"]
        PEC --> PE
...
|----------------|--------------|--------------|-------------|
| 9.0.0 | 2.0 | 25 | 3.5 |
| 8.8.0 | 2.0 | 21 | 3.5 (3.5.7) |
| 8.2.0 – 8.7.x | 2.0 | 21 | 3.2 – 3.3 |
| 8.0.0 – 8.1.x | 2.0 | 17 | 3.1 |
| 7.x | 2.0 | 8+ | 2.x |
...
- [Process Engine Bootstrap](./process-engine-bootstrap.md) — creating and managing the engine lifecycle
