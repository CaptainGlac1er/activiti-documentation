...
slug: /api-reference/engine-api/bpmn-converter
title: "BPMN Converter"
...
<DirectoryTree rootName="activiti-bpmn-converter" expandAll dotWalk showFirst={5}>
        ...
        <DirectoryTree.Dir name="org">
          <DirectoryTree.Dir name="activiti">
            <DirectoryTree.Dir name="bpmn">
              <DirectoryTree.Dir name="converter">
                <DirectoryTree.File name="BpmnXMLConverter.java" />
                <DirectoryTree.File name="BaseBpmnXMLConverter.java" />
                <DirectoryTree.File name="UserTaskXMLConverter.java" />
                <DirectoryTree.File name="ServiceTaskXMLConverter.java" />
                <DirectoryTree.File name="StartEventXMLConverter.java" />
                <DirectoryTree.File name="EndEventXMLConverter.java" />
                <DirectoryTree.File icon="…" name="More converters" />
                <DirectoryTree.Dir name="child">
                  <DirectoryTree.File name="BaseChildElementParser.java" />
                  <DirectoryTree.File name="ElementParser.java" />
                  <DirectoryTree.File name="MultiInstanceParser.java" />
                  <DirectoryTree.File name="DocumentationParser.java" />
                  <DirectoryTree.File icon="…" name="More parsers" />
                </DirectoryTree.Dir>
                <DirectoryTree.Dir name="export">
                  <DirectoryTree.File name="DefinitionsRootExport.java" />
                  <DirectoryTree.File name="ProcessExport.java" />
                  <DirectoryTree.File name="BPMNDIExport.java" />
                  <DirectoryTree.File name="MultiInstanceExport.java" />
                  <DirectoryTree.File name="ActivitiListenerExport.java" />
                  <DirectoryTree.File icon="…" name="More exporters" />
                </DirectoryTree.Dir>
                <DirectoryTree.Dir name="parser">
                  <DirectoryTree.File name="DefinitionsParser.java" />
                  <DirectoryTree.File name="ProcessParser.java" />
                  <DirectoryTree.File name="ExtensionElementsParser.java" />
                  <DirectoryTree.File icon="…" name="More parsers" />
                </DirectoryTree.Dir>
                <DirectoryTree.Dir name="util">
                  <DirectoryTree.File name="BpmnXMLUtil.java" />
                  <DirectoryTree.File name="CommaSplitter.java" />
                  <DirectoryTree.File name="InputStreamProvider.java" />
                </DirectoryTree.Dir>
              </DirectoryTree.Dir>
              <DirectoryTree.File name="DelegatingXMLStreamWriter.java" />
              <DirectoryTree.File name="IndentingXMLStreamWriter.java" />
              <DirectoryTree.File name="XMLStreamReaderUtil.java" />
            </DirectoryTree.Dir>
          </DirectoryTree.Dir>
        </DirectoryTree.Dir>
      </DirectoryTree.Dir>
      <DirectoryTree.Dir name="exceptions">
        <DirectoryTree.File name="XMLException.java" />
      </DirectoryTree.Dir>
    </DirectoryTree.Dir>
  </DirectoryTree.Dir>
</DirectoryTree>
...
public class ExtensionElement extends BaseElement {
  ...
  public void addChildElement(ExtensionElement childElement) {
    if (childElement != null && StringUtils.isNotEmpty(childElement.getName())) {
      List<ExtensionElement> elementList = childElements.get(childElement.getName());
      if (elementList == null) {
        elementList = new ArrayList<>();
        childElements.put(childElement.getName(), elementList);
      }
...
> **Note:** Child elements are grouped by element name: `childElements` is a `Map<String, List<ExtensionElement>>` keyed by the child's `name`, so several children with the same name are collected under one key.
...
| `ComplexGatewayXMLConverter` | `complexGateway` | `ExclusiveGateway` |
| `EventGatewayXMLConverter` | `eventBasedGateway` | `EventGateway` |
...
The complex gateway is **not supported** at runtime: `ComplexGatewayXMLConverter` converts a `<complexGateway>` element to an `ExclusiveGateway` during XML parsing, which is why the produced Java type is `ExclusiveGateway` rather than `ComplexGateway`.
