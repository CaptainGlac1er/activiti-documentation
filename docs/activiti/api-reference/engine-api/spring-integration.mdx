...
slug: /api-reference/engine-api/spring-integration
...
<DirectoryTree rootName="activiti-spring" expandAll dotWalk showFirst={5}>
        ...
        <DirectoryTree.Dir name="org">
          <DirectoryTree.Dir name="activiti">
            <DirectoryTree.Dir name="spring">
              <DirectoryTree.File name="SpringProcessEngineConfiguration.java" />
              <DirectoryTree.File name="ProcessEngineFactoryBean.java" />
              <DirectoryTree.File name="SpringTransactionContext.java" />
              <DirectoryTree.File name="SpringTransactionContextFactory.java" />
              <DirectoryTree.File name="SpringTransactionInterceptor.java" />
              <DirectoryTree.File name="SpringExpressionManager.java" />
              <DirectoryTree.File name="ApplicationContextElResolver.java" />
              <DirectoryTree.File name="SpringConfigurationHelper.java" />
              <DirectoryTree.File name="SpringAsyncExecutor.java" />
              <DirectoryTree.File name="SpringRejectedJobsHandler.java" />
              <DirectoryTree.File name="SpringCallerRunsRejectedJobsHandler.java" />
              <DirectoryTree.File name="SpringEntityManagerSessionFactory.java" />
              <DirectoryTree.File name="SpringAdvancedBusinessCalendarManagerFactory.java" />
              <DirectoryTree.Dir name="autodeployment">
                <DirectoryTree.File name="AutoDeploymentStrategy.java" />
                <DirectoryTree.File name="AbstractAutoDeploymentStrategy.java" />
                <DirectoryTree.File name="DefaultAutoDeploymentStrategy.java" />
                <DirectoryTree.File name="SingleResourceAutoDeploymentStrategy.java" />
                <DirectoryTree.File name="ResourceParentFolderAutoDeploymentStrategy.java" />
                <DirectoryTree.File name="FailOnNoProcessAutoDeploymentStrategy.java" />
                <DirectoryTree.File name="NeverFailAutoDeploymentStrategy.java" />
              </DirectoryTree.Dir>
              <DirectoryTree.Dir name="impl">
                <DirectoryTree.Dir name="test">
                  <DirectoryTree.File name="SpringActivitiTestCase.java" />
                  <DirectoryTree.File name="CleanTestExecutionListener.java" />
                </DirectoryTree.Dir>
              </DirectoryTree.Dir>
            </DirectoryTree.Dir>
          </DirectoryTree.Dir>
...
**Note:** Internal, deprecated API. This interface is marked `@Deprecated @Internal` in source — it may change or be removed without notice, and Activiti recommends against using the legacy Job Executor.
...
> **Note:** The rejected-jobs handling below references `SpringRejectedJobsHandler`, which is `@Deprecated @Internal` (an internal, deprecated API) — see the note in the [SpringRejectedJobsHandler](#springrejectedjobshandler) section above.
...
public class WorkflowServiceTest {
    ...
    public void testStartProcess() {
        // RuntimeService (legacy API) returns the legacy engine ProcessInstance —
        // mock that interface rather than constructing the modern-API model class
        ProcessInstance pi = mock(org.activiti.engine.runtime.ProcessInstance.class);
        when(pi.getId()).thenReturn("1");
        when(runtimeService.startProcessInstanceByKey("key")).thenReturn(pi);
...
spring:
  activiti:
    database-schema-update: true|false|create-drop|create|drop-create
...
- [Spring Boot Starter](./spring-boot-starter.mdx)
