...
> **Note:** The rejected-jobs handling below references `SpringRejectedJobsHandler`, which is `@Deprecated` — see the note in the [SpringRejectedJobsHandler](#springrejectedjobshandler) section above.
