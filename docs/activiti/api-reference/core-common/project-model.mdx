...
<DirectoryTree rootName="activiti-project-model" expandAll dotWalk showFirst={5}>
          ...
          <DirectoryTree.Dir name="activiti">
            <DirectoryTree.Dir name="core">
              <DirectoryTree.Dir name="common">
                <DirectoryTree.Dir name="project">
                  <DirectoryTree.Dir name="model">
                    <DirectoryTree.File name="ProjectManifest.java" />
                  </DirectoryTree.Dir>
                </DirectoryTree.Dir>
              </DirectoryTree.Dir>
            </DirectoryTree.Dir>
...
```mermaid
flowchart TD
    subgraph PM["Project Model"]
        PMF["ProjectManifest<br/>(Project Metadata Model)<br/>Identity:<br/>- id: String<br/>- name: String<br/>- description: String<br/>- version: String<br/>Authorship:<br/>- createdBy: String<br/>- creationDate: String<br/>- lastModifiedBy: String<br/>- lastModifiedDate: String"]
    end
```
